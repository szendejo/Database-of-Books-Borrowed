...
public class StudentListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView lvStudents = (ListView) view.findViewById(R.id.listViewStudents);
        // Setup cursor adapter using cursor
        StudentCursorAdapter cursorAdapter = new StudentCursorAdapter(getActivity(), stuCursor, 0);
        // Attach cursor adapter to the ListView
        lvStudents.setAdapter(cursorAdapter);
